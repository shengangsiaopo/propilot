...
char RS232_Out_Data[CDC_DATA_IN_EP_SIZE+1];		// bad Microchip code

#define RS232_IntRec_Buf 16
#if defined(__18CXX)
	#pragma udata myCDC=CDC_BUFFER_ADDRESS
#endif
unsigned char RS232_In_Buffer[RS232_IntRec_Buf];
unsigned char RS232_In_Head = 0, RS232_In_Tail = 0;	// interrupt driven circular buffer
unsigned char ucInt;

char cPrintBuf[CDC_DATA_OUT_EP_SIZE];
...
/** VECTOR REMAPPING ***********************************************/
	...
	void YourLowPriorityISRCode()
	{
		...
		//	PIR1bits.RCIF = 0;    // clear Flag
			...
			RS232_In_Head++;
			if ( RS232_In_Head > (RS232_IntRec_Buf - 1) )
				RS232_In_Head = 0;
		}
	#endif
