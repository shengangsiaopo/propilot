...
PIN NEAR_BUF DIO[48] = {
		...
		ANALOG(1,1,6,AUX_START+16,0x0672, 0x0672, 0x0672, 0x0672),	// 25 - SAmps - TODO factor converts 0-4096 to 0-3300 mA
		ANALOG(1,1,7,AUX_START+17,0x2805, 0x2805, 0x2805, 0x2805),	// 26 - SVolt - factor converts 0-4096 to 0-20500 mV
		ANALOG(1,1,0,AUX_START+18,0x0672, 0x0672, 0x0672, 0x0672),	// 27 - AUX_AN1 - factor converts 0-4096 to 0-3300 mV
		ANALOG(1,1,1,AUX_START+19,0x0672, 0x0672, 0x0672, 0x0672),	// 28 - AUX_AN2 - factor converts 0-4096 to 0-3300 mV
		ANALOG(1,1,3,AUX_START+20,0x0672, 0x0672, 0x0672, 0x0672),	// 29 - AUX_AN3 - factor converts 0-4096 to 0-3300 mV
		ANALOG(1,1,4,AUX_START+21,0x0672, 0x0672, 0x0672, 0x0672),	// 30 - AUX_AN4 - factor converts 0-4096 to 0-3300 mV
