...
#define SERVO_PULSE_RANGE 2500
#define SERVO_PULSE_REV -2500
...
MIXER pMixers[MIX_NUM_OUTPUTS+1][MIX_PER_CHANNEL]  __attribute__ ((section(".myDataSection"),address(0x2100))) = {
{
	{	/* Channel1 (Throttle) */
		...
		.iScales = { 7500, 2500 } }, }, { {         /*Channel2 (Aileron1) */
		...
		.iScales = { 7500, 2500 } }, }, { {         /*Channel3 (Elevator) */
		...
		.nType = { UNUSED_MIX, UNUSED, UNUSED, toQ15( 0.000 ) }, }, {
		.nType = { UNUSED_MIX, UNUSED, UNUSED, toQ15( 0.000 ) }, }, {
		.iScales = { 7500, 2500 } }, }, { {         /*Channel4 (Rudder) */
		...
		.nType = { UNUSED_MIX, UNUSED, UNUSED, toQ15( 0.000 ) }, }, {
		.nType = { UNUSED_MIX, UNUSED, UNUSED, toQ15( 0.000 ) }, }, {
		.iScales = { 7500, 2500 } }, }, { {         /*Channel5 (FLAPS) */
		...
		.nType = { UNUSED_MIX, UNUSED, UNUSED, toQ15( 0.000 ) }, }, {
		.nType = { UNUSED_MIX, UNUSED, UNUSED, toQ15( 0.000 ) }, }, {
		.iScales = { 7500, 2500 } }, }, { {         /*Channel6 (Aileron2) */
		.pType = { BALANCED_HALF_FACTOR, RC_ROLL, DCM_ROLL, RC_MODE_FAILSAFE, toQ10( 1.000 ) }, }, {
		.nType = { UNUSED_MIX, UNUSED, UNUSED, toQ15( 0.000 ) }, }, {
		.nType = { UNUSED_MIX, UNUSED, UNUSED, toQ15( 0.000 ) }, }, {
		.nType = { UNUSED_MIX, UNUSED, UNUSED, toQ15( 0.000 ) }, }, {
		...
		.iScales = { 7500, -2500 } }, }, { {         /*Channel7 (CAM_P) */
		...
		.nType = { UNUSED_MIX, UNUSED, UNUSED, toQ15( 0.000 ) }, }, {
		.nType = { UNUSED_MIX, UNUSED, UNUSED, toQ15( 0.000 ) }, }, {
		.iScales = { 7500, 2500 } }, }, { {         /*Channel8 (CAM_Y) */
