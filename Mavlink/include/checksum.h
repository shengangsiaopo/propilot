 ...
 **/
STATIC_FUN inline void crc_accumulate(uint8_t data, uint16_t *crcAccum)
{
 ...
 */
STATIC_FUN inline void crc_init(uint16_t* crcAccum)
{
 ...
 **/
STATIC_FUN inline uint16_t crc_calculate(uint8_t* pBuffer, int length)
{
 ...
 * @return the checksum over the buffer bytes
 **/
STATIC_FUN inline uint16_t crc_calculate_msg(mavlink_message_t* pMSG, int length)
{
