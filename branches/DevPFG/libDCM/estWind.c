...
int IMPORTANTz groundVelocityHistory[3];
int IMPORTANTz fuselageDirectionHistory[3];

unsigned int IMPORTANTz estimatedAirspeed;
int IMPORTANTz estimatedWind[3];
